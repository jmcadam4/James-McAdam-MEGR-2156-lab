...
Now that we had our g-code, we were ready to print. We took the usb thumb drive over to the Prusa number 4, plugged it in, and pressed print. The most important part of the print is often the first layer so it was a massive sigh of relief when it printed well. I didn't get good pictures from the print we did in class as I got swept away in conversation with an instructor talking about the other additive manufacturing lab's 3d printers and their capabilities so I reprinted the legos at home in order to show how it went in this writeup. The images above show the print bed and extruder temps that were used as well as what a good first layer looked like for this part. The printer held an extruder temp of 220 and a bed temp of 55 deg C for the duration of the print in order to ensure even layer adhesion and consistent extrusion. The first layer also printed much slower than the rest as plastic bonds to plastic a lot better than plastic bonds to a steel print bed.
...
In the making of this part, I learned that not all overhangs need support if it's over a small enough gap. I also learned that Prusa's Core One printers are really good, I've only used more dated models of theirs but I was impressed by the features and build quality. It was nice we used a material like PLA because I don't think there is any humidity control built into the side pocket where the filament sits and PLA is pretty resistant to moisture. This lab also was my first experience with the Prusa slicer. I liked that you could control the amount of settings available to change with the experience level at the top right. Being able to see just the necessary fields for an easy off the shelf print while also being able to toggle on manual controls when printing a more delicate part is a game changer. I also owe a huge thank you to Stigern and Fudge on Printables for their models of the grumpy cat and lego brick respectively. 
