...
I learned that I should do more research into 3d printing fine details like threads as there are limitations I haven't quite figured out yet. I have gotten M2.5 threads before for a prototype but these were more like 1.8 mm which was too ambitious. I also refreshed my memory on infill types and their ideal applications. I had been using gyroid a lot to the extent that I honestly forgot why so it was nice to do some reading into it. I also learned infill and wall count don't scale with size. If you have a big part with 50 percent infill and a small part with 50 percent infill, it's similarly effective on both but the larger part will use much more infill. Because it is a percentage, it scales automatically with the size of the print. Choosing the wrong infill or wall thickness can lead to many issues in practice, if I were to be 3d printing a hub for a RC car wheel and made it with one wall, it would likely break rather quickly and leave us with some very unhappy customers and a low quality part being returned frequently. On the other hand if I made the part with 100 percent infill as a solid cylinder, the customers would be complaining about it being too heavy and slowing their car down. There is a balance to be had and the more we practice printing throughout this course, the closer we will be to finding said balance.
